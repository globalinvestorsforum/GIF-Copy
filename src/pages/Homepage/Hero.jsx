...
const Hero = () => {
  ...
  >
    <h2 className="md:p-24 p-5 pt-24 md-pt-0 text-3xl md:text-6xl lg:text-7xl font-bold tracking-wide leading-10  w-1/2">IT'S A PLATFORM WHERE GETS DONE NOT JUST DISCUSSED.</h2>
  </section>
  )
}
